...
export default function RegisterPage() {
  ...
  const validate = () => {
    ...
    if (!/^[a-z0-9]+$/i.test(form.username)) e.username = 'Letters and numbers only';
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      toast.success('Welcome to Kinophile!');
    ...
    <main className="min-h-screen bg-cinema-950 flex items-center justify-center px-4 py-20">
      ...
      <div className="w-full max-w-md relative">
        ...
        <div className="form-card">
          <h1 className="font-display text-xl text-white mb-6">Create your account</h1>
          <button
